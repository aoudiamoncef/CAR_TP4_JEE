...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="/sortbyyearasc">Sort by year ASC</a>
                    </li><li><a href="/sortbyyeardesc">Sort by year DESC</a></li>
                </ul>
            </li>
        ...
        <form class="navbar-form navbar-left" method="post" action="/findauthor">
            <div class="form-group">
                <input type="text" class="form-control" name="findauthor" placeholder="Author...">
            </div>
...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <table class="table">
            ...
            <%
                Collection <Book> books = (Collection <Book>) request.getAttribute("findauthor");
