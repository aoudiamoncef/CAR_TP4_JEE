...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <table class="table">
            ...
            <%
                Collection<Book> books = (Collection<Book>) request.getAttribute("stock");
                ...
                for (Book book: books) {
                    ...
                    out.print("<form method=\"post\" action=\"/deleteaddbook\">");
                    ...
                    out.print("<input type=\"number\" class=\"form-control\"" + "name=\"number\" id=\"number\" min=\"1\"" + " max=\"1000000\"value=\"0\">");
